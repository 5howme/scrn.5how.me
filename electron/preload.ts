...
import type { RecordingSession, StoreRecordedSessionInput } from "../cmmn/lib/recordingSession";
import type { ShortcutBinding } from "../cmmn/lib/shortcuts";
import { NATIVE_BRIDGE_CHANNEL, type NativeBridgeRequest } from "../cmmn/native/contracts";
...
contextBridge.exposeInMainWorld("electronAPI", {
	...
	saveSettingsPreset: (preset: unknown) => {
		return ipcRenderer.invoke("save-settings-preset", preset);
	},
	loadSettingsPreset: () => {
		return ipcRenderer.invoke("load-settings-preset");
	},
