...
import { ShortcutBinding } from "../cmmn/lib/shortcuts";
		...
		},
		{
			...
			submenu: [
				...
				},
				{
					...
					// The role's default is CmdOrCtrl+Plus, which physically requires
					// Shift on most layouts; bind the plain "=" key instead.
					accelerator: "CommandOrControl+=",
				},
				// Hidden aliases keep the classic zoom-in combos working.
				{
					role: "zoomIn",
