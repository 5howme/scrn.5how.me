...
// Chromium persists Ctrl+= / Ctrl+- page zoom per origin, so a zoom made in the
// editor window silently applies to every window of the app on load. The fixed-size
// overlay windows (HUD, source selector, countdown) then render content larger than
// their bounds and clip. Pin them to 100% zoom.
function lockZoomAt100(win: BrowserWindow) {
