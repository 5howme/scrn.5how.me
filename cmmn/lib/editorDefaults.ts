...
import {
	...
	DEFAULT_WEBCAM_SIZE_HEIGHT,
	DEFAULT_WEBCAM_SIZE_WIDTH,
...
export const DEFAULT_EDITOR_APPEARANCE_SETTINGS: {
	...
	// Shadow strength and roundness are whole preview px (0-64, steps of 4).
	shadowIntensity: 16,
	showBlur: false,
	motionBlurAmount: 0,
	borderRadius: 16,
...
export const DEFAULT_EDITOR_LAYOUT_SETTINGS: {
	...
	// Absolute inset in preview px (0-64, steps of 4).
	padding: 32,
	aspectRatio: "16:9",
...
export const DEFAULT_WEBCAM_SETTINGS = {
	...
	sizeWidth: DEFAULT_WEBCAM_SIZE_WIDTH,
	sizeHeight: DEFAULT_WEBCAM_SIZE_HEIGHT,
