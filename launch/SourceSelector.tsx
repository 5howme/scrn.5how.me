...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "../cmmn/components/ui/tabs";
...
export function SourceSelector() {
	...
	return (
		<div className={`h-screen overflow-hidden flex flex-col ${styles.glassContainer}`}>
			<div className="flex-1 min-h-0 flex flex-col w-full px-3.5 pt-3.5">
				<Tabs
